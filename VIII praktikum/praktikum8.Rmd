...
Joonista ka gammajaotuse tihedusfunktsioonid Γ(α,β) erinevate α∈{1,2,3,4,5} ja β∈{1,2,3,4,5} jaoks. Selgita, kuidas muutub jaotus, kui muudame kumbagi parameetrit.
